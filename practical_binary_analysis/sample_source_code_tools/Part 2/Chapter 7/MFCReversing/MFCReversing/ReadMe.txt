================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: MFCReversing プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した MFCReversing には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには MFCReversing アプリケーションを構成している各ファイ
ルの概要説明が含まれます。

MFCReversing.vcxproj
...
MFCReversing.h
   ...
   CMFCReversingApp アプリケーション クラスを宣言します。

MFCReversing.cpp
   これは、アプリケーション クラス CMFCReversingApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\MFCReversing.ico
   これは、アプリケーションのアイコンとして使用されるアイコンファイルです。この
   アイコンはメイン リソース ファイル MFCReversing.rc に含まれていま
   す。

res\MFCReversing.rc2
...
MFCReversingDlg.h, MFCReversingDlg.cpp - ダイアログ
   これらのファイルは CMFCReversingDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な MFCReversing.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   MFCReversing.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
